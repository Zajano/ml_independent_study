...
# Date: 5/8/2020
# Description: uses web driver to gather stats not available from API
...
# TODO: fix last break - 21+ string for community age:
#   Requesting https://boardgamegeek.com/boardgame/125493/drunkquest/stats
#   Traceback (most recent call last):
#   File "API_w_Driver_scraping.py", line 176, in <module>
#   com_age = get_results(age_poll)
#   File "API_w_Driver_scraping.py", line 31, in get_results
#   val = int(result.xpath('./@value').extract()[0])
#   ValueError: invalid literal for int() with base 10: '21 and up'
...
# first 256 pages of bgg - everything with 30 or more community votes
...
out_file = open(file_name + '.csv', 'w', encoding='utf-8', newline='')
...
for i in range(len(game_links)):
    ...
    # fans and page views - timeout exception from too requests
    try:
